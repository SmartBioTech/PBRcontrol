...
class DatabaseInit:
    ...
    def initialize_database(self):
        ...
        cursor.execute('CREATE TABLE IF NOT EXISTS log (device_id VARCHAR(255),time_issued VARCHAR(255),command_id INT,target VARCHAR(255),response VARCHAR(1000),time_executed VARCHAR(255))')
